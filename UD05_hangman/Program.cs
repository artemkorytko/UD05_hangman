            ...
            {
                {
                    ...
                    while (errors < MaxErrors && opennedLetter != guessWordArray.Length)
                    {
                        ...
                        else // ...символ не угадал
                        {
                            ...
                            ///======================Такая буква уже была! вывести какие были и предупредить, не дав ввести повторно неправильную букву
                            ////=====================ТУТ безуспешно пытаюсь сделать массив неправильных букв =======================================
                            /// "засунуть переменную letter в массив false_entered_Array" - как?
                            //Array.Resize(ref false_entered_Array, errors); //каждый раз меняет размер массива
                            //Console.WriteLine($"Эти буквы не подошли":{false_entered_Array}");
                        }
